      ...
      <div
        ...
        className={cn(
          ...
          variant === 'floating' || variant === 'inset'
            ...
            : 'border-zinc-200/80 group-data-[collapsible=icon]:w-(--sidebar-width-icon) group-data-[side=left]:border-r group-data-[side=right]:border-l dark:border-zinc-800/80',
          className
        )}
        {...props}
      >
